...
export default function SeeDrag() {
  ...
  const onStart = () => {
    ...
    setState( B => { return { ...B, activeDrags: activeDrags + 1 } });
  };

  const onStop = () => {
    const {activeDrags} = setState;
    setState( C => { return { ...C, activeDrags: activeDrags - 1 } });
  };
  ...
  const adjustXPos = (e) => {
    ...
    setState( D => { return {controlledPosition: {x: x - 10, y} } } );
  };
  ...
  const adjustYPos = (e) => {
    ...
    setState( E => { return {controlledPosition: {x, y: y - 10} } } );
  };

  const onControlledDrag = (e, position) => {
    const {x, y} = position;
    setState( F => { return {controlledPosition: {x, y}} });
  };
...
//   // PropTypes is not available in environment, but here they are.
//   // static propTypes = {
